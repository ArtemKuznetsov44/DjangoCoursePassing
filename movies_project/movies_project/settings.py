...
SECRET_KEY = 'django-insecure-bxby-oh0bc2q7+ss8#mhkr+99cnr2(l4hlsu)rd@h5m04hiuff'
...
STATIC_URL = 'static/'
# Simple variable to config path for static dir:
STATIC_DIR = os.path.join(BASE_DIR, 'static')
# # Where django can find static files:
STATICFILES_DIRS = [STATIC_DIR]

# The main project directory - ROOT DIRECTORY - for static files:
...
# This setting is only set if we want to use the widget of ckeditor with file upload:
